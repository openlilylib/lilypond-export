...
music = \new PianoStaff <<
  \new Staff <<
    { \time 3/4 \key es \major \set Timing.tempoWholesPerMinute = #(ly:make-moment 30) \partial 4 s4 | \repeat volta 2 { \grace s8 s2.*3 } }
    \relative <<
      { b'4\f | \appoggiatura des8 c4.\accent a8 g4 | g( bes) <g b> | \tuplet 3/2 { a c a~ } a | } \\
      { r4 | e8\f f g fis e4 | es2 d4 | <c e>8[\> <b dis> <bes d>] <a cis>\p  <c f>4 }
    >>
  >>
  \new Staff {
